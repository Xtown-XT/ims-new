...
import { Modal, Select, Table, Button, Input, Form } from "antd";
  ...
  const columns = [
    ...
    { title: "Amount", dataIndex: "amount", key: "amount" },
    {
      ...
      render: (status) => (
        <span
          style={{
            backgroundColor: status === "Approved" ? "lightgreen" : "skyblue",
            padding: "2px 8px",
            borderRadius: "6px",
          }}
        >
            ...
            <div className="bg-white rounded-2xl w-full max-w-md p-6 relative">
              ...
              <div className="flex justify-end gap-3 mt-4">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-violet-400 text-white hover:bg-violet-600 transition"
                >
                  Add Expense
                </button>
              </div>
