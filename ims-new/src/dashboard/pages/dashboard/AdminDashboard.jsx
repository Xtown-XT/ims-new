  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-5">
        <div>
          ...
          <p className="text-gray-500">
            You have <span className="text-orange-500 font-semibold">200+</span>{" "}
            Orders, Today
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        <div className="bg-orange-400 text-white p-5 rounded-lg shadow hover:shadow-md transition">
        ...
        <div className="bg-blue-600 text-white p-5 rounded-lg shadow hover:shadow-md transition">
          <div className="flex justify-between items-center">
            <div>
              <h4 className="text-sm font-medium opacity-90">
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-md ${
                    label === "1Y"
                      ...
                      : "text-gray-600 bg-gray-100 hover:bg-orange-100"
                  }`}
                >
                  {label}
                </button>
            ...
            <div className="flex-1">
              ...
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={barData}>
                  ...
                  />
                  <Bar dataKey="purchase" stackId="a" fill="#fde68a" radius={[8, 8, 0, 0]} />
                  <Bar dataKey="sales" stackId="a" fill="#f97316" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        <div className="bg-white shadow rounded-xl p-5 border flex flex-col justify-between">
          ...
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="bg-orange-500 p-2 rounded-full text-white cursor-pointer">
                <FiSettings size={18} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              ...
              <div className="flex flex-col items-center bg-gray-50 p-3 rounded-lg">
                <FaUsers className="text-orange-500 text-xl mb-1" />
        ...
        return (
          <div
            ...
            className={`w-6 h-6 rounded-md ${
              highlight ? "bg-orange-400" : "bg-orange-100"
            }`}
          ></div>
        );
      })}
