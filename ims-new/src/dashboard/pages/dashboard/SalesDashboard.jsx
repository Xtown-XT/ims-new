    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow rounded-xl p-6 flex justify-between items-center">
          <div>
            <h3 className="text-orange-500 font-medium text-sm mb-2">
              Weekly Earning
            </h3>
        ...
        {/* Total Sales 1 */}
        <div className="bg-orange-400 text-white shadow rounded-xl p-6 flex justify-between items-center relative overflow-hidden">
          <div>
