...
function Dashboard() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            You have <span className="text-orange-500 font-semibold">200+</span> Orders, Today
          </p>
        </div>
      ...
      {/* Welcome Banner */}
      <div className="bg-orange-500 rounded-xl text-white p-8 flex justify-between items-center relative">
        <div>
